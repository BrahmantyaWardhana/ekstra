...
export default function AccountDropdown() {
  ...
  const dropDownItemStyle =
    "block px-4 py-2 text-sm text-gray-800 dark:text-neutral-200 hover:bg-gray-100 dark:hover:bg-neutral-700";

  return (
    <Menu>
      <div className="relative inline-block w-full">
        <MenuButton className="flex group w-full items-center gap-x-3 p-2 rounded-lg hover:bg-gray-100 data-active:bg-gray-100 dark:hover:bg-neutral-700 dark:data-active:bg-neutral-700 transition-colors duration-150 hover:cursor-pointer ">
          {({ active }) => (
            <>
              <img
        ...
        <MenuItems
          modal={false} // prevent locking UI until dropdown is closed
          transition
          className="
