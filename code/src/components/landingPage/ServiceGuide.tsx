      ...
      <section className="py-20">
        <div className="container mx-auto grid items-center gap-10 px-6 md:grid-cols-2">
          <div>
            ...
            <ol className="mt-6 space-y-4 text-sm text-black">
              <li className="flex items-start gap-3">
                <span className="mt-1 inline-flex size-6 items-center justify-center rounded-full bg-emerald-800/20 text-emerald-200">
                  1
                </span>
